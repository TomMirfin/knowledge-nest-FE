...
<template>
  ...
  >
    ...
    >
      Your Local
      <span
        class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-white"
        >Talents</span
      >
    </h1>
    <p
    ...
    >
      ...
      engineers, plumbers,gardeners, or any other specialized skill, our
      platform connects you with highly skilled individuals ready to bring your
      vision to life. Get started today and let's unleash the full potential of
      your team.
    </p>
  </section>
</template>
