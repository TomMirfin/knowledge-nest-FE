 ...
 *
 * @checksum - 98fbdd8d68452dab84d2801d370e9e55844d33b500f25ea73d525b818a236283
 * @variables -
 * @theme - starter
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  togglebuttons__input: {
    ...
    'group-data-[vertical="false"]/options:group-first/option:!rounded-none':
      true,
    'group-data-[vertical="true"]/options:group-first/option:!rounded-none':
      true,
    ...
    'group-data-[vertical="true"]/options:group-first/option:!rounded-br-none':
      true,
    'group-data-[vertical="false"]/options:group-last/option:!rounded-none':
      true,
    'group-data-[vertical="true"]/options:group-last/option:!rounded-none':
      true,
